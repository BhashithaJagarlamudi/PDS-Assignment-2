# Load the data
diabetes <- read.csv("/Users/bhashithajagarlamudi/Desktop/assignment 2/rawdata/diabetes.csv")
...
write.csv(diabetes_clean, "/Users/bhashithajagarlamudi/Desktop/assignment 2/clean data/diabetes_cleaned.csv", row.names = FALSE)

diabetes_clean = read.csv("/Users/bhashithajagarlamudi/Desktop/assignment 2/clean data/diabetes_cleaned.csv")
...
write.table(result_df, file = "/Users/bhashithajagarlamudi/Desktop/assignment 2/results/Mean_Max_Glucosevalues", row.names = FALSE)
...
write.table(result_df, file = "/Users/bhashithajagarlamudi/Desktop/assignment 2/results/Mean_Max_Population", row.names = FALSE)
...
ggsave("/Users/bhashithajagarlamudi/Desktop/assignment 2/results/Mean_Comparison.png")
...
ggplot(max_data, aes(x = Type, y = Glucose, fill = Type)) +
  ...
  theme_bw()
# Save the plot as a png file
ggsave("/Users/bhashithajagarlamudi/Desktop/assignment 2/results/Max_Comparison.png")
...
write.table(c(sample_bmi_percentile, pop_bmi_percentile), file = "/Users/bhashithajagarlamudi/Desktop/assignment 2/results/bmi_percentiles.txt")
...
# Save the plot as a png file
ggsave("/Users/bhashithajagarlamudi/Desktop/assignment 2/results/compare_98thpercentile.png")
...
write.table(result_df, file = "/Users/bhashithajagarlamudi/Desktop/assignment 2/results/bootstrap_mean_avg_sd_percentile_values", row.names = FALSE)
...
write.table(result_df, file = "/Users/bhashithajagarlamudi/Desktop/assignment 2/results/pop_mean_sd_percentile_values", row.names = FALSE)
...
# Save the plot as a png file
ggsave("/Users/bhashithajagarlamudi/Desktop/assignment 2/results/mean_bloodpressure_values_comparison.png")
...
# Save the plot as a png file
ggsave("/Users/bhashithajagarlamudi/Desktop/assignment 2/results/sd_bloodpressure_comparison.png")
...
# Save the plot as a png file
ggsave("/Users/bhashithajagarlamudi/Desktop/assignment 2/results/_bloodpressure_comparison.png")
